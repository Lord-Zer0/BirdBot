...
class Bird:
    IMGS = BIRD_IMGS
    MAX_ROTATION = 25               # angle of rotation
    ROT_VEL = 20                    # velocity to rotate at
    ANIMATION_TIME = 5              # time for each animation to display
    ...
    def jump(self):
        self.vel = -10.5            # negative velocity moves upwards
    ...
    def move(self):
        ...
        d = self.vel*self.tick_count + 1.5*self.tick_count**2 # d=vt+1.5t^2 (displacement formula)
